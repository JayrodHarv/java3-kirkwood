...
public class Users extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(userFromSession == null || !userFromSession.getStatus().equals("active")) {
            ...
            resp.sendRedirect("smp-login?redirect=smp-users");
            return;
        }
        ...
        try {
            ...
            session.setAttribute("flashMessageDanger", "Unable to retrieve list of users:\n" + ex.getMessage());
        }

        req.setAttribute("pageTitle", "No Go Outside Users");
        req.getRequestDispatcher("WEB-INF/smp/smp-users.jsp").forward(req, resp);
    }
}
