...
<%--                <img src="${appURL}/images/smp/learnx-logo-light.png" style="height: 32px" alt="Logo">--%>
            </a>
        </div>
        ...
        <div class="col-md-3 text-end">
            <a href="${appURL}/smp-login" class="btn btn-outline-orange me-2">Login</a>
            <a href="${appURL}/smp-signup" class="btn btn-orange">Sign-up</a>
        </div>
    </header>
</div>