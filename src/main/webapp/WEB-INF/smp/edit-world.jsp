...
<main class="container py-3" style="margin-top: 75px; margin-bottom: 40px;">
    <form action="${appURL}/edit-world" method="POST">
        ...
        <div class="container-fluid p-0">
            ...
            <input type="hidden" name="oldWorldID" value="${world.getWorldID()}">

            <!-- World Name -->
            <div class="input-group mb-4">
                <label for="worldID" class="input-group-text">World Name *</label>
                <input type="text" class="form-control rounded-end <c:if test="${not empty results.worldIDError}">is-invalid</c:if>" placeholder="Ex. SummerSMP2022" id="worldID" name="worldID" value="${world.getWorldID()}">
            ...
            <div class="input-group mb-4">
                ...
                <input type="date" class="datepicker form-control rounded-end <c:if test="${not empty results.dateStartedError}">is-invalid</c:if>" id="dateStarted" name="dateStarted" value="${world.getDateStarted()}">
            ...
            <div class="input-group mb-4">
                ...
                <input type="text" class="form-control rounded-end <c:if test="${not empty results.descriptionError}">is-invalid</c:if>" id="description" name="description" value="${world.getDescription()}">
